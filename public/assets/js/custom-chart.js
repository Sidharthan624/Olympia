let dailyOrderArrays = document.getElementById("dailyOrderArray").value;
    console.log(dailyOrderArrays,"monthlySalesArray");
...
(function ($) {
    ...
    console.log(dailyOrderArray,"monthlySalesArray");
